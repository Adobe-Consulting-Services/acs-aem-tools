...
<html>
    ...
    <body id="acs-tools-query-editor">
        ...
        <div id="qeApp" ng-controller="QueryEditorCtrl" ng-init="running = true; refresh()">
            <header class="top">
                ...
                <div class="drawer theme-dark">
                    ...
                    <span class="auto-query-wrapper">
                        <label><input type="checkbox" ng-model="autoQuery" ng-change="refresh()">
            ...
            <div ng-show="status.requesting"
                 class="query-run-overlay-wrapper">
                <div class="query-run-overlay"></div>
                <div class="wait-indicator spinner large"></div>
            </div>
